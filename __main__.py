...
def main():
    ...
    nick_name_cloud = my_word_cloud.MyWordCloud(nick_name_space_split, mask_image="images/animal.jpeg")
    ...
    signature_cloud = my_word_cloud.MyWordCloud(signature_word_space_split, mask_image="images/animal.jpeg")
